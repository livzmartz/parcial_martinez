        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/parcial_martinez/"><i class="bi bi-house-fill me-2"></i>Inicio</a>
                    </li>
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/parcial_martinez/usuarios"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Usuarios</a>
                            </li>
